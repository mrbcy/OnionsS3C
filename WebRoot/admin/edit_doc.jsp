		...
		<main class="main-cont content mCustomScrollbar">
            ...
            <div class="page-wrap">
                <form action="${pageContext.request.contextPath}/admin/AdminServlet" method="post">
                	<input type="hidden" name="op" value="editDoc"></input>
                	<input type="hidden" name="id" value="${doc.id }"></input>
                    <div class="form-group-col-2">
                        <div class="form-label">文档标题：</div>
                        <div class="form-cont">
                            <input type="text" name="title" placeholder="文档标题..." class="form-control form-boxed" value="${doc.title}">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                        <div class="form-label">url：</div>
                        <div class="form-cont">
                            <input type="text" name="url" placeholder="留空则发布到系统内" class="form-control form-boxed" style="width:400px;" value="${doc.url}">
                        </div>
                    </div>
                    <div class="form-group-col-2">
                        <div class="form-label">tags：</div>
                        <div class="form-cont">
                            <input type="text" name="tag" placeholder="标签..." class="form-control form-boxed" style="width:400px;" value="${doc.tags }">
                        </div>
                    </div>
                    <!--开始::结束-->
                    <textarea id="editor" name="content">${doc.content }</textarea>
                    <!--<div id="editor">-->
